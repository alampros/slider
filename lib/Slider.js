...
var Slider = (function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var customHandle = this.props.handleComponent;
      ...
      var track = (0, _react.cloneElement)(this.props.trackComponent, {
      ...
      var steps = (0, _react.cloneElement)(this.props.stepsComponent, {
        prefixCls: prefixCls,
        vertical: vertical,
        marks: marks,
        dots: dots,
...
Slider.propTypes = {
  ...
  handleComponent: _react2['default'].PropTypes.element,
  trackComponent: _react2['default'].PropTypes.element,
  stepsComponent: _react2['default'].PropTypes.element,
...
Slider.defaultProps = {
  ...
  step: 1,
  marks: {},
  handleComponent: _react2['default'].createElement(_Handle2['default'], null),
  trackComponent: _react2['default'].createElement(_Track2['default'], null),
  stepsComponent: _react2['default'].createElement(_Steps2['default'], null),
  onBeforeChange: noop,
  onChange: noop,
  onAfterChange: noop,
